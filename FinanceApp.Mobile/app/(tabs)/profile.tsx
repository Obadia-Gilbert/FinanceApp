    ...
    >
        ...
        <View style={styles.avatarWrap}>
          <View style={[styles.avatar, { backgroundColor: colors.brand }]}>
            <Text style={styles.avatarText}>
              {(firstName || profile?.firstName || user?.firstName)?.[0] ?? displayEmail?.[0] ?? '?'}
            </Text>
          </View>
          <TouchableOpacity
      ...
      <Card style={styles.menuCard}>
        ...
        <TouchableOpacity style={[styles.menuRow, { borderBottomColor: colors.border }]}>
          ...
          <View style={styles.menuLabelWrap}>
            ...
            <Text style={[styles.menuSub, { color: colors.text.muted }]}>USD ($)</Text>
          </View>
          <Text style={[styles.menuArrow, { color: colors.text.subtle }]}>›</Text>
        </TouchableOpacity>
      ...
      <Card style={styles.menuCard}>
        ...
        <View style={styles.menuRow}>
          <Text style={styles.menuEmoji}>🎨</Text>
          <Text style={[styles.menuLabel, { color: colors.text.primary }]}>Appearance</Text>
          <Text style={[styles.menuArrow, { color: colors.text.subtle }]}>›</Text>
        </View>
      </Card>
...
const styles = StyleSheet.create({
  ...
  editAvatarIcon: { color: '#fff', fontSize: 14 },
