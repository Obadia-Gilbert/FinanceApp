...
namespace FinanceApp.Infrastructure.Migrations
{
    ...
    [Migration("20260302213057_AddCategoryBudgetTable")]
    partial class AddCategoryBudgetTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.CategoryBudget", b =>
                {
                    ...
                    b.HasIndex("UserId", "CategoryId", "Month", "Year")
                        .IsUnique()
                        .HasFilter("[UserId] IS NOT NULL AND [CategoryId] IS NOT NULL AND [Month] IS NOT NULL AND [Year] IS NOT NULL");
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Category", b =>
                {
                    b.HasOne("FinanceApp.Domain.Common.BaseEntity", null)
                        .WithOne()
                        .HasForeignKey("FinanceApp.Domain.Entities.Category", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.CategoryBudget", b =>
                {
                    ...
                    b.HasOne("FinanceApp.Domain.Common.BaseEntity", null)
                        .WithOne()
                        .HasForeignKey("FinanceApp.Domain.Entities.CategoryBudget", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FinanceApp.Domain.Entities.Expense", b =>
                {
                    ...
                    b.HasOne("FinanceApp.Domain.Common.BaseEntity", null)
                        .WithOne()
                        .HasForeignKey("FinanceApp.Domain.Entities.Expense", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
